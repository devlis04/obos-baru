-- Pengirim: satu layar = satu tanggal buku.
-- Nota dikirim tanpa cap buku hanya ikut jika tanggal order Jakarta = tanggal buku.
-- Kunjungan tidak dicampur hari ini dengan tanggal buku lain.
-- Jalankan SETELAH 058 (dan 069 jika ada). Boleh diulang.
